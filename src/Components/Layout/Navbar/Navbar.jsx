                  ...
                  <div>
                    ...
                    {mobileEvent && (
                      <div className="ml-5 border-l border-[#e5d2ad] pl-4">
                        ...
                        <Link
                          href="/services/event/baby-ceremony"
                          onClick={() => setMobileMenu(false)}
                          className="block py-2.5 text-[10px] uppercase tracking-[1.2px] text-[#777] hover:text-[#c58b22]"
                        >
                          Baby Ceremony
...
//         <Link href="/" className="group flex items-center">
//           {/* Camera Icon */}
//           <div className="mr-2 text-[35px] leading-none text-[#c58b22]">♧</div>
