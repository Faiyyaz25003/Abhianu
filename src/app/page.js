...
/* ---- Portfolio: tab order (first one is the default) ---- */
...
/* ---- Portfolio: images per tab (extensions must match exactly, case-sensitive) ---- */
const portfolioData = {
  Wedding: [
    "/Wedding/Wedding1.jpeg",
    "/Wedding/Wedding2.jpeg",
    "/Wedding/Wedding3.jpeg",
    "/Wedding/Wedding4.jpeg",
  ],
  Anchor: [
    "/Anchor/Anchor1.jpeg",
    "/Anchor/Anchor2.jpg",
  ...
  Corporate: [
    "/Corporate/Corporate1.jpg",
    "/Corporate/Corporate2.jpg",
    "/Corporate/Corporate3.jpg",
    "/Corporate/Corporate4.jpg",
  ],
  Devotional: [
    "/Devotional/Devotional1.jpg",
    "/Devotional/Devotional2.jpg",
    "/Devotional/Devotional3.jpg",
    "/Devotional/Devotional4.jpg",
  ],
  BTS: [
    "/BTS/BTS1.JPG",
    "/BTS/BTS2.JPG",
...
export default function Home() {
  // Wedding tab is selected by default
  const [activeFilter, setActiveFilter] = useState("Wedding");
  const [mobileOpen, setMobileOpen] = useState(false);

  // Only the images of the selected tab
  const filteredPortfolio = portfolioData[activeFilter] || [];
